...
public class Chemical_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("info.chenli.litway.bionlp13.Chemical");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "info.chenli.litway.bionlp13.Chemical");
